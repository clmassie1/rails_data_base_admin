...
class AudiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post audios_url, params: { audio: { description: @audio.description, title: @audio.title } }
    end
  ...
  test "should update audio" do
    patch audio_url(@audio), params: { audio: { description: @audio.description, title: @audio.title } }
